                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemCount: _courseScheduleController
                                      .semesters.length,
                                  itemBuilder: (context, index) {
                                    final semester = _courseScheduleController
                                        .semesters[index];
                                                          ...
                                                          Expanded(
                                                              child: Container(
                                                                  decoration: BoxDecoration(
                                                                      border: Border(
                                                                          bottom:
                                                                              BorderSide(color: CupertinoDynamicColor.resolve(CupertinoColors.systemGrey4, context)),
                                                                          right: BorderSide(color: CupertinoDynamicColor.resolve(CupertinoColors.systemGrey4, context)))))),
                                                        Expanded(
                                                            child: Container(
                                                                decoration: BoxDecoration(
                                                                    border: Border(
