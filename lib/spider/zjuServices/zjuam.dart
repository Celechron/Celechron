...
class ZjuAm {
  ...
  static Future<Cookie> getSsoCookie(
    ...
    request = await httpClient.getUrl(Uri.parse('https://zjuam.zju.edu.cn/cas/login'));
    ...
    var exponentStr = RegExp(r'"exponent":"(.*?)"').firstMatch(body)?.group(1);
    ...
    if (response.cookies.any((element) => element.name == 'iPlanetDirectoryPro')) {
